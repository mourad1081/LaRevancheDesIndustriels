...
#ifndef UI_PARAMETRESSON_H
#define UI_PARAMETRESSON_H
...
"    border: 1px solid #444;\n"
"}"));
        verticalLayout_2 = new QVBoxLayout(ParametresSon);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        groupBox_2 = new QGroupBox(ParametresSon);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        verticalLayout = new QVBoxLayout(groupBox_2);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        checkBoutonActiverSon = new QCheckBox(groupBox_2);
        checkBoutonActiverSon->setObjectName(QStringLiteral("checkBoutonActiverSon"));
        checkBoutonActiverSon->setChecked(true);
        checkBoutonActiverSon->setTristate(false);
        ...
        retranslateUi(ParametresSon);
        QObject::connect(buttonBox, SIGNAL(accepted()), ParametresSon, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), ParametresSon, SLOT(reject()));

        QMetaObject::connectSlotsByName(ParametresSon);
    } // setupUi

    void retranslateUi(QDialog *ParametresSon)
    {
...
namespace Ui {
    class ParametresSon: public Ui_ParametresSon {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PARAMETRESSON_H
